...
> **Last updated:** 2026-04-24 (Gate 0 playtest fixes — 10 prioritized items shipped: P1 bug fixes on optimistic UI flip + multi-beat unification + interruption feature-flag + first_morning/residue preclusion + segment auto-advance; P2 skills-nudge + early-build banner; P3 dorm-smell rewrite + orientation_fair reactivated as Day 1 afternoon pool storylet + pre-game friction statement card on welcome flow.)
