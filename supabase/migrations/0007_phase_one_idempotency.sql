...
-- Social boosts once-per-day is enforced in app logic; boost payload stores day_index (not a column), so DB uniqueness is deferred (TODO: consider explicit column in future if needed).
